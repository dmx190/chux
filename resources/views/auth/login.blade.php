        ...
        <div class="row">
            <div class="col-md-2 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Lectura Actual</div>
                    <div class="panel-body">
                        <div class="form-group">
                            <div id="temp">
                                <center><img src="img/loading-gif.gif" width="40"></center>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-1">0</div>
                            <div class="col-md-6">
                                <input type="range" min="0" max="100" id="rangeTemp" value="0" disabled="disabled">
                            </div>
